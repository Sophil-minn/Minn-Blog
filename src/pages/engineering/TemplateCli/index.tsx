  ...
  return (
    <div className='info-container'>
      ...
      <Paragraph>
        ...
        <Collapse
          size="small"
          items={[{ key: '1', label: '文章通用模版', children: <p> <SimpleCode value={code2} height={300} /></p> }]}
        />
        <Divider />
        <Collapse
          size="small"
          items={[{
            key: '1', label: '带有锚点定位的组件模版', children: <p>
              <SimpleCode value={code13} height={300} /></p>
          }]}
        />
      </Paragraph>
      ...
      <Paragraph>
        <Collapse
          size="small"
          items={[{ key: '1', label: 'node脚本代码示例', children: <p> <SimpleCode value={code1} height={900} /></p> }]}
        />
      </Paragraph>
    </div>
  );
